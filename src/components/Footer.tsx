    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">MuseumPass</h3>
            <p className="text-gray-400">
              Discover the world's finest museums and exhibitions with easy online booking.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/museums" className="text-gray-400 hover:text-white">
                  Museums
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} MuseumPass. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
